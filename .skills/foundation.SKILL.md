...
Read `reference.PROJECT.md`, `CONTEXT.md`, both architecture documents, `docs/scope.md`, `docs/conventions.md`, `docs/release.md`, and any ADRs. Create missing structural files and folders that these documents deterministically require; pause when their contents require a product or operational decision.
...
- `AGENTS.md` pointing agents to `.skills/README.md`, `reference.PROJECT.md`, `CONTEXT.md`, and canonical project docs.
